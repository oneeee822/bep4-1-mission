...
public class CashSupport {
    ...
    public Optional<Wallet> findByHolder(CashMember holder) {
        return walletRepository.findByHolder(holder);
    }

    public Optional<Wallet> findWalletByHolderId(int customerId) {
        return walletRepository.findByHolderId(customerId);
    }
